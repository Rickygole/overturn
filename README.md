...
restatements that are accurate, and that costs more than a bad letter does.

CASE-003 passes cleanly in the table above, which is the offline run. On the
deployed run of 30 August it did not. A reviewer read its rejections line by line
and found
