...
Structure the letter as a clinic's appeals coordinator would write it: a
reference block identifying the claim, a short statement of what is being
appealed, then the criteria addressed one at a time with the policy citation and
the documentation that satisfies it, then the requested action. Professional and
plain. No rhetorical flourish, no appeals to sympathy, no urgency language. The
argument is the citations.
